...
<head runat="server">
    <title>Chapter14.HelloSilverlight</title>
    <style type="text/css">
    html, body {
	    height: 100%;
	    overflow: auto;
...
<body>
    ...
    <div id="silverlightControlHost">
        ...
        <object data="data:application/x-silverlight-2," id="silverlightObject" type="application/x-silverlight-2" width="100%" height="100%">
          ...
          <param name="InitParams" value="alex=mackey,sharyn=mackey" />
